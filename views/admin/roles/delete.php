          ...
          <form class="form-horizontal" role="form" id="idForm" method="POST">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                        <label for="name" class="col-sm-12 control-label"><h3>Удалить роль #<?php echo $data['role_id']; ?></h3>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button id="save" type="submit" name="submit" class="save btn btn-primary">Delete Role</button>
                </div>
            </div>
